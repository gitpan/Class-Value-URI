package Class::Value::URI::fax_TEST;
...
Class::Value::URI::fax_TEST - Test companion class
...
Test companion class for L<Class::Value::URI::fax>. Gets its
test data from L<Data::Semantic::URI::TestData::fax>.

Class::Value::URI::fax_TEST inherits from L<Class::Value::Test> and
...
This document describes version 0.01 of L<Class::Value::URI::fax_TEST>.
