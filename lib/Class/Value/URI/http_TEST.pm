package Class::Value::URI::http_TEST;
...
Class::Value::URI::http_TEST - Test companion class
...
Test companion class for L<Class::Value::URI::http>. Gets its
test data from L<Data::Semantic::URI::TestData::http>.

Class::Value::URI::http_TEST inherits from L<Class::Value::Test> and
...
This document describes version 0.01 of L<Class::Value::URI::http_TEST>.
