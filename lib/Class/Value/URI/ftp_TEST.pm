...
Class::Value::URI::ftp_TEST - Test companion class
...
Class::Value::URI::ftp_TEST inherits from L<Class::Value::Test> and
...
This document describes version 0.01 of L<Class::Value::URI::ftp_TEST>.
